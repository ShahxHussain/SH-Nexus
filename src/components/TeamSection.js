...
const TeamSection = ({ title, subtitle, members, type, bgColor = 'bg-gray-50' }) => {
  const getGridCols = () => {
    switch (type) {
      case 'founders':
          ...
          {members.map((member, index) => (
            ...
            >
              ...
              <div className="relative mb-6">
                ...
                {(type === 'founders' || type === 'ambassadors') && (
                  <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    {member.email && (
                      <a
                        ...
                        className="w-8 h-8 bg-gray-600 rounded-full flex items-center justify-center text-white hover:bg-gray-700 transition-colors duration-300"
                        aria-label="Email"
                      >
                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {/* Member Info */}
              <h3 className={`${
                type === 'founders' ? 'text-2xl' : 'text-xl'
              } font-bold text-neutral-dark mb-2`}>
                {member.name}
              </h3>
